...
public class Blue_LastCall extends AutoBase
{
    ...
    public static class Paths
    {
        ...
        private void buildPathsReg(Follower follower)
        {
            ...
            final Pose ballOneLinePose = new Pose(54.000, 60.000);
            final Pose ballOneFullPose = new Pose(17.000, 60.000);
            final Pose gateHitPose = new Pose(16.000, 69.000);
            final Pose gateControlPoint = new Pose(23.000, 65.000); // Bezier control point

            final Pose shootPose = new Pose(54.000, 97.200);

            final Pose ballTwoLinePose = new Pose(54.000, 35.000);
            final Pose ballTwoFullPose = new Pose(16.000, 35.000);

            final Pose ballThreeLinePose = new Pose(54.000, 84.000);
            final Pose ballThreeFullPose = new Pose(18.000, 84.000);

            final Pose gateLinePose = new Pose(54.000, 69.000); // new: Path 13 endpoint
