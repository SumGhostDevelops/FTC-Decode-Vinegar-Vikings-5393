...
public class PedroConstants
{
        ...
        public static MecanumConstants driveConstants = new MecanumConstants()
                        .maxPower(1)
                        .rightFrontMotorName(RobotConstants.Drive.WHEEL_NAMES.FRONT_RIGHT.get())
                        .rightRearMotorName(RobotConstants.Drive.WHEEL_NAMES.BACK_RIGHT.get())
                        .leftRearMotorName(RobotConstants.Drive.WHEEL_NAMES.BACK_LEFT.get())
                        .leftFrontMotorName(RobotConstants.Drive.WHEEL_NAMES.FRONT_LEFT.get())
        ...
        public static PinpointConstants localizerConstants = new PinpointConstants()
                        ...
                        .forwardPodY(RobotConstants.Odometry.Deadwheels.Forward.OFFSET.get().toUnit(DistanceUnit.INCH).magnitude)
                        .strafePodX(RobotConstants.Odometry.Deadwheels.Strafe.OFFSET.get().toUnit(DistanceUnit.INCH).magnitude)
