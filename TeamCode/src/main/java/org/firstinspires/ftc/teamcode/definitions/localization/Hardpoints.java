...
public class Hardpoints
{
    ...
    {
        public static final Pose2d BLUE_LOADING_ZONE = new Pose2d(coord(135.32, 8.17), deg(180));
        public static final Pose2d RED_LOADING_ZONE = new Pose2d(coord(8.68, 8.17), deg(0));
