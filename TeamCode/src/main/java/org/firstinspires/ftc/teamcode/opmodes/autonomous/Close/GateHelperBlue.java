...
@Autonomous(name = "GateHelperBlue", group = " Blue", preselectTeleOp = "BlueVikingsTeleOp")
public class GateHelperBlue extends AutoBase {
     private Paths paths;
...
// --- Pose Definitions ---
            ...
            final Pose approachPose  = new Pose(11.000, 8.000);
            final Pose hitPose       = new Pose(20.000, 12.000);
            final Pose curveControl  = new Pose(14.000, 25.000);
            final Pose exitPose      = new Pose(10.000, 12.000);
            final Pose swingLinePose = new Pose(25.000, 24.000);
            final Pose swingFullPose = new Pose(10.000, 24.000);
            final Pose finalPosePose = new Pose(20.000, 12.000);
