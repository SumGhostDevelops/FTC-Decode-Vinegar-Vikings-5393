...
public class Red extends Base
{
        ...
        public static class Paths
        {
                ...
                public PathChain ToShoot, ToBallOne, ToBallOneFull, ToBallTwo, ToBallTwoFull, ToThree, ToThreeFull,
                                ToShoot_1, ToShoot_2, ToShoot_3, ToShoot_4,
                                // Gate-specific paths used in buildPathsGate
                                Gate, Eat, Gate_2, Eat_2, Gate_3, Eat_3, Move, bottomBalls, bottomBallsEat, ToShoot_5,
                                upperBalls, upperEat, upperTurn, toShoot, FinalPose, finalPose;

                public enum PathState
                {
                        ToShoot, ToBallOne, ToBallOneFull, ToBallTwo, ToBallTwoFull, Gate1, Gate2, ToEatGate, ToThree,
                        ToThreeFull, ToShoot_1, ToShoot_2, ToShoot_3, ToShoot_4, Move,
                        // Gate-specific states
                        Gate, Eat, Gate_2, Eat_2, Gate_3, Eat_3, bottomBalls, bottomBallsEat, ToShoot_5, upperEat,
                        upperBalls, upperTurn, toShoot, finalPose, FinalPose
                }
                ...
                private void buildPathsBasic(Follower follower)
                {
                        ...
                        Move = follower.pathBuilder().addPath(new BezierLine(shootPose, randomPose))
                                        .setConstantHeadingInterpolation(Math.toRadians(38)).build();
                ...
                private void buildPathsReg(Follower follower)
                {
                        ...
                        ToBallTwo = follower.pathBuilder().addPath(new BezierLine(shootPose, ballTwoFullPose // Using
                                                                                                             // ballTwoFullPose
                                                                                                             // directly
                                                                                                             // as per
                                                                                                             // your new
                        ...
                        ToBallTwoFull = follower.pathBuilder().addPath(new BezierLine(ballTwoFullPose, ballThreeLinePose // Using
                                                                                                                         // ballThreeLinePose
                                                                                                                         // as
                                                                                                                         // per
                                                                                                                         // your
                        ...
                        ToShoot_2 = follower.pathBuilder().addPath(new BezierLine(ballThreeLinePose, shootPose))
                                        .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(37)).build();

                        ToThree = follower.pathBuilder().addPath(new BezierLine(shootPose, gateLinePose // Using
                                                                                                        // gateLinePose
                                                                                                        // as per your
                                                                                                        // new path
                                                                                                        // logic
                        ...
                        ToThreeFull = follower.pathBuilder().addPath(new BezierLine(gateLinePose, gatePushPose))
                                        .setTangentHeadingInterpolation().build();

                        ToShoot_3 = follower.pathBuilder().addPath(new BezierLine(gatePushPose, shootPose))
                                        .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(37)).build();

                        FinalPose = follower.pathBuilder().addPath(new BezierLine(shootPose, finalPose))
                                        .setConstantHeadingInterpolation(Math.toRadians(37)).build();
                }
                ...
                private void buildPathsGate(Follower follower)
                {
                        ...
                        ToShoot = follower.pathBuilder().addPath(new BezierLine(startPose,
                        ...
                        ToBallOne = follower.pathBuilder().addPath(new BezierLine(shootPose,
                        ...
                        ToBallOneFull = follower.pathBuilder().addPath(new BezierLine(ballOneLinePose,

                                        ballOneFullPose)).setTangentHeadingInterpolation()

                                        .build();

                        ToShoot_1 = follower.pathBuilder().addPath(new BezierLine(ballOneFullPose,
                        ...
                        Gate = follower.pathBuilder().addPath(new BezierLine(shootPose,
                        ...
                        Eat = follower.pathBuilder().addPath(new BezierCurve(gateLinePose,
                        ...
                        ToShoot_2 = follower.pathBuilder().addPath(new BezierLine(eatLinePose,
                        ...
                        Gate_2 = follower.pathBuilder().addPath(new BezierLine(shootPose,

                                        gateLinePose)).setTangentHeadingInterpolation()

                                        .build();

                        Eat_2 = follower.pathBuilder().addPath(new BezierCurve(gateLinePose,
                        ...
                        ToShoot_3 = follower.pathBuilder().addPath(new BezierLine(eatLinePose,
                        ...
                        Gate_3 = follower.pathBuilder().addPath(new BezierLine(shootPose,
                        ...
                        ToShoot_4 = follower.pathBuilder().addPath(new BezierLine(eatLinePose,
                        ...
                        bottomBalls = follower.pathBuilder().addPath(new BezierLine(shootPose,
                        ...
                        bottomBallsEat = follower.pathBuilder().addPath(new BezierLine(ballThreePose,

                                        ballThreeFullPose)).setTangentHeadingInterpolation()

                                        .build();

                        ToShoot_5 = follower.pathBuilder().addPath(new BezierLine(ballThreeFullPose,
                        ...
                        upperBalls = follower.pathBuilder().addPath(new BezierLine(shootPose,

                                        ballPickPose)).setTangentHeadingInterpolation()

                                        .build();

                        upperEat = follower.pathBuilder().addPath(new BezierLine(ballPickPose,
                        ...
                        upperTurn = follower.pathBuilder().addPath(new BezierLine(TurnPose,

                                        topEatPose)).setTangentHeadingInterpolation()

                                        .build();

                        toShoot = follower.pathBuilder().addPath(new BezierLine(topEatPose,
                        ...
                        finalPose = follower.pathBuilder().addPath(new BezierLine(TurnPose,

                                        randomPose)).setTangentHeadingInterpolation()
